...
const Divisions = () => {
    return (
        <div className={classes.Divisions}>
            ...
            />
            <Division 
                description="Our goal is to creatively and efficiently educate families about the importance of wellness (Physically, Mentally, Socially, Spiritually, Environmentally, and Emotionally). In our education efforts, we will also be raising awareness about health disparities & promotions."
